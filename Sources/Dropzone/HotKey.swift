...
@MainActor struct ShortcutName {
    static func text(key: UInt32, modifiers: UInt32) -> String {
        ...
        let names: [UInt32: String] = [49: L("Пробел"), 0:"A", 1:"S", 2:"D", 3:"F", 4:"H", 5:"G", 6:"Z", 7:"X", 8:"C", 9:"V", 11:"B", 12:"Q", 13:"W", 14:"E", 15:"R", 16:"Y", 17:"T", 31:"O", 32:"U", 34:"I", 35:"P", 37:"L", 38:"J", 40:"K", 45:"N", 46:"M"]
        return prefix + (names[key] ?? (L("Клавиша ") + "\(key)"))
    }
}
