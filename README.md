...
Статус: исследование и спецификация MVP. Исходников приложения, сборки и релиза пока нет. Визуальное направление будет уточнено по UI-референсам автора проекта.
